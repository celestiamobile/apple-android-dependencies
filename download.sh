...
wget "https://github.com/LuaJIT/LuaJIT/archive/d06beb0480c5d1eb53b3343e78063950275aa281.tar.gz" -O "${LUAJIT_VERSION}.tar.gz" --no-check-certificate
...
wget "https://github.com/google/breakpad/tarball/e5dc1f86b2defc8f76b56fb473b804e42e75c41d" -O "${BREAKPAD_VERSION}.tar.gz" --no-check-certificate
...
wget "https://github.com/KhronosGroup/OpenGL-Registry/tarball/6fdfecda943798736fae0f3292528ece1c1b001c" -O "${OPENGL_VERSION}.tar.gz" --no-check-certificate
...
wget "https://github.com/libsdl-org/SDL/releases/download/release-2.30.2/${SDL2_VERSION}.tar.gz" --no-check-certificate
